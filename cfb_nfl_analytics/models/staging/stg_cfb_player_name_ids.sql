...
-- Converted from: /Users/riley.gisseman/Downloads/cfb_nfl_dev_env/Data & Modeling/modeling/pre/cfb_player_name_ids.sql
-- cfb_player_name_ids
...
with player_years as (
   ...
   , player_histories as (
    ...
    from player_years           as a
         left join {{ source("raw", "nfl_players") }}  as np on np.display_name = a.player_name and a.year + 1 = np.draft_year
            and case
