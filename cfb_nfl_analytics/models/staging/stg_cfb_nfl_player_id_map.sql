...
-- Converted from: /Users/riley.gisseman/Downloads/cfb_nfl_dev_env/Data & Modeling/modeling/pre/cfb_nfl_player_id_map.sql
-- cfb_nfl_player_id_map
...
with player_id_trace as (
    ...
    from {{ source("raw", "nfl_players") }}                   as np
         left join {{ ref("stg_cfb_player_name_ids") }} as ni
        ...
        from marts.nfl_historical_value_estimate
        group by
            1, 2
