...
-- Converted from: /Users/riley.gisseman/Downloads/cfb_nfl_dev_env/Data & Modeling/modeling/model/cfb_historical_value_estimate.sql
...
with game_log_dim as (
    ...
    from {{ ref("cfb_game_logs") }}                                      as n
         inner join {{ ref("cfb_beta_priors") }}                         as b on b.position_group = n.position_group and team_snaps > 0
         ...
         left join {{ ref("cfb_team_strength_adjustment_metrics") }}     as team_adj
