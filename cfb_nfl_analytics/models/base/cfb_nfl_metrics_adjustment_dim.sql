...
-- Converted from: /Users/riley.gisseman/Downloads/cfb_nfl_dev_env/Data & Modeling/modeling/adjustment layer/cfb_nfl_metrics_adjustment_dim.sql
...
with cfb_nfl_metrics_adjustment_dim as (
    ...
    from {{ ref("cfb_game_logs") }}                                       as a
         inner join {{ ref("nfl_game_logs") }}                            as b
         ...
         inner join {{ ref("cfb_team_strength_adjustment_metrics") }}     as a_team_adj
