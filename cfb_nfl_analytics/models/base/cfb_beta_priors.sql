...
-- Converted from: /Users/riley.gisseman/Downloads/cfb_nfl_dev_env/Data & Modeling/modeling/adjustment layer/cfb_beta_priors.sql
-- cfb_beta_priors
...
with players_grouping as (
    ...
    from {{ ref("cfb_game_logs") }}                                      as gl
         ...
         left join {{ ref("cfb_team_strength_adjustment_metrics") }}     as team_adj on team_adj.team_elo = coalesce(gl.team_elo, 1000) and team_adj.position_group = gl.position_group
         left join {{ ref("cfb_nfl_metrics_adjustment_dim") }}           as nfl_adj on nfl_adj.position_group = gl.position_group
    where
