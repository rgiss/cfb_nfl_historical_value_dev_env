drop table nfl_pbp_2024;
create table nfl_pbp_2024
(
    play_id                              float,
    game_id                              varchar(255),
    old_game_id                          float,
...
copy nfl_pbp_2024(play_id, game_id, old_game_id, home_team, away_team, season_type, week, posteam, posteam_type, defteam, side_of_field, yardline_100, game_date,
    ...
    from '/Users/riley.gisseman/Downloads/play_by_play_2024.csv'
    delimiter ','
    csv header;